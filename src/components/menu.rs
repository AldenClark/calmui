...
crate::impl_disableable!(MenuItem, |this, value| this.disabled = value);
crate::impl_disableable!(Menu, |this, value| this.disabled = value);
crate::impl_openable!(Menu, |this, value| this.opened = Some(value));
