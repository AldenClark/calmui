...
use gpui::{IntoElement, ParentElement, RenderOnce, SharedString, Styled, Window, div};
...
crate::impl_sized_via_method!(Breadcrumbs, size);

crate::impl_disableable!(BreadcrumbItem, |this, value| this.disabled = value);
