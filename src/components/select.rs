...
use gpui::{
    AnyElement, IntoElement, ParentElement, RenderOnce, SharedString, Styled, Window, canvas, div,
    px,
};
...
crate::impl_variant_size_radius_via_methods!(Select, variant, size, radius);
...
crate::impl_variant_size_radius_via_methods!(MultiSelect, variant, size, radius);
...
crate::impl_disableable!(SelectOption, |this, value| this.disabled = value);
crate::impl_disableable!(Select, |this, value| this.disabled = value);
crate::impl_disableable!(MultiSelect, |this, value| this.disabled = value);
crate::impl_openable!(Select, |this, value| {
    this.opened = Some(value);
    this.opened_controlled = true;
});
crate::impl_openable!(MultiSelect, |this, value| {
    this.opened = Some(value);
    this.opened_controlled = true;
});
